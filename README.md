...
|:------|:------------|:------------|
| `pair` | Parameter / observation metric | Required |
| `donor_hla` | Parameter / observation metric | Required |
| `recipient_hla` | Parameter / observation metric | Required |
...
docker run -p 8000:8000 hla-compatibility-matcher
```
