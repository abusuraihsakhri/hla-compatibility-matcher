"""
Automated Pytest for hla-compatibility-matcher Enrichment Modules.
"""
import sys
...
from enrichment import (
    EpletDatabaseIntegrationEngine,
    TransplantOutcomePredictionEngine,
    HlahaplotypingModuleEngine,
    VirtualCrossmatchEngine,
    AllelelevelResolutionEngine,
    PopulationFrequencyDatabaseEngine,
    KdpiScoringEngine,
    RestApiServerEngine,
    HlacompatibilitymatcherEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HlacompatibilitymatcherEnrichmentSuite()
